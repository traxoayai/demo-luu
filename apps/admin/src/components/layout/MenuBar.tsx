...
import logoNamViet from '../../app/Logo Nam Viet.png';
...
export default function MenuBar({
  ...
  const isMenuHasActiveChild = (children?: any[]) => {
    ...
    return children.some(child => child.id === activePage);
  };
        ...
        {!isDesktopCollapsed && (
          <div className="flex items-center gap-2 overflow-hidden px-1">
            <div className="w-7 h-7 rounded-full overflow-hidden shadow-sm shrink-0 bg-white">
               <Image src={logoNamViet} alt="Nam Viet Logo" width={28} height={28} className="object-cover" />
            </div>
