          ...
          <div className="p-6 md:p-10 flex-1">
            ...
            <div className="flex items-center gap-4 mb-6 text-sm">
              <div className="flex items-center text-amber-400">
                ...
                <span className="text-slate-500 ml-2 font-medium">(128 đánh giá)</span>
              </div>
            ...
            <div className="flex gap-6 border-b border-slate-200 mb-6">
              ...
              >
                Cách dùng
                {activeTab === "usage" && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600 rounded-t-full" />}
              </button>
              <button 
              ...
              >
                Giao hàng
                {activeTab === "shipping" && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600 rounded-t-full" />}
              </button>
            </div>
              ...
              {activeTab === "shipping" && (
                <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-bold text-slate-700">Miễn phí giao hàng</p>
                      <p className="text-slate-500 text-xs mt-0.5">Cho mọi đơn hàng từ 500k toàn quốc</p>
                    </div>
                  </div>
                </div>
              )}
